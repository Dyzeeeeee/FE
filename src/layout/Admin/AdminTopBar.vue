...
const routeName = computed(() => {
    ...
    if (route.path === '/admin/home') {
        return 'HOME';
    } else if (route.path === '/admin/orders') {
        return 'ORDERS';
    }
    else if (route.path === '/admin/menu') {
        return 'MENU';
    }
    else if (route.path === '/admin/takeorder') {
        return 'TAKE ORDER';
    }
...
const showComponent = computed(() => {
    return route.path !== '/admin/home' && route.path !== '/admin/sales' && route.path !== '/admin/more';
});
</script>