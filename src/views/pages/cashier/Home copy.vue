    ...
    <div class="grid grid-cols-12 xl:gap-3 gap-2 -m-5 xl:-m-3 mb-10 mt-1">
        ...
        <div class="col-span-12 min-h-[25vh] max-h-[40vh] mb-2 px-8 relative">
            ...
            <div class="flex gap-4 pb-0 mt-1 text-sm xl:text-9xl font-bold p-0 overflow-x-auto whitespace-nowrap "
                ...
                <div class="card border-[2px] rounded-xl h-auto  min-w-[80vw] m-0  border-white p-0 ">
                    <div class=" w-full">
                        <div
                ...
                <div class="card border-[0px] rounded-xl h-auto  min-w-[80vw] m-0  border-yellow-500  p-0">
                    <div class=" w-full">
                        <div
                ...
                <div class="card border-[1px] rounded-xl h-auto bg-yellow-200 min-w-[80vw] m-0 text-black p-4">
                    <div class=" w-full">
